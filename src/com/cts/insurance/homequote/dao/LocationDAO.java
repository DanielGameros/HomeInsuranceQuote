...
public class LocationDAO {
	...
	public int saveLocation(final Location location) throws HomequoteSystemException
	{
		...
		try
		{
			...
			//(NULL, ?, ?, ?, ?, ?, ?, ?, ?)";
			//"INSERT INTO Locations (QUOTE_ID, RESIDENCE_TYPE, ADDRESS_LINE_1, ADDRESS_LINE_2, CITY, STATE, ZIP, RESIDENCE_USE, USER_NAME)
			//VALUES (QUOTE_SEQUENCE.nextval, ?, ?, ?, ?, ?, ?, ?, ?)"
			...
			//getting the QUOTE_ID here because the database is using a sequence to auto-increment so the int this method returns is being 
			//used to set the quoteID for that location object 
...
//	 */
//	public void setQuoteId(Location location) throws HomequoteSystemException {
//
//		LOGGER.info("LocationDAO.saveLocation - starts");
//		Connection conn = null;
//		PreparedStatement stmt = null;
...
//			}
//		}
//		LOGGER.info("LocationDAO.setQuoteId - ends");
//	}
